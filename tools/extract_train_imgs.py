...
flags.DEFINE_string('output_dir', '/home/plantvillage/Dropbox/Object_Detection/spore/data/train_images/22/22_originals', 'Path to directory to output TFRecords.')
