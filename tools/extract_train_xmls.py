...
flags.DEFINE_string('output_dir', '/home/plantvillage/Dropbox/Object_Detection/spore/data/train_images/22/22_originals_xmls', 'Path to directory to output TFRecords.')
flags.DEFINE_string('trainval_path','/home/plantvillage/Dropbox/Object_Detection/spore/data/annotations/trainval_22.txt','Path to trainval txt file with list of files')
FLAGS = flags.FLAGS
